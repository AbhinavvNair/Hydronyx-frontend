...
function PolicyContent() {
  ...
  const [states, setStates] = useState<string[]>([
    'Maharashtra', 'Haryana', 'Punjab', 'Uttar Pradesh', 'Rajasthan', 'Gujarat', 'Madhya Pradesh',
  ]);
        ...
        <div className="grid grid-cols-3 gap-8">
          ...
          <div className="bg-gradient-to-br from-cyan-500/10 to-blue-500/10 border border-cyan-500/30 rounded-xl p-6 h-fit">
            ...
            <div className="space-y-6">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-300 mb-2">Pumping Change (%)</label>
              ...
              <div>
                <label className="block text-sm font-medium text-gray-300 mb-2">Recharge Structures (Units)</label>
              ...
              <div>
                <label className="block text-sm font-medium text-gray-300 mb-2">Crop Intensity Change (%)</label>
            ...
            {simulationResult && chartData.length > 0 ? (
              <ResponsiveContainer width="100%" height={300}>
                <LineChart data={chartData}>
                  ...
                  <YAxis stroke="#888" />
                  <Tooltip contentStyle={{ backgroundColor: '#0a1428', border: '1px solid #00d4ff', borderRadius: '8px' }} formatter={(value: number) => value.toFixed(2)} />
                  <Legend />
                  <Line type="monotone" dataKey="baseline" stroke="#888" strokeWidth={2} strokeDasharray="5 5" name="Baseline" dot={false} />
                  <Line type="monotone" dataKey="intervention" stroke="#00d4ff" strokeWidth={3} name="Intervention" dot={false} />
                </LineChart>
              </ResponsiveContainer>
            ) : (
          ...
          <div className="mt-8 grid grid-cols-3 gap-6">
            <div className="bg-gradient-to-br from-cyan-500/10 to-blue-500/10 border border-cyan-500/30 rounded-xl p-6">
              ...
              <p className="text-4xl font-bold text-cyan-400">
                {simulationResult.mean_effect > 0 ? '+' : ''}{simulationResult.mean_effect.toFixed(3)}m
              </p>
            ...
            <div className="bg-gradient-to-br from-purple-500/10 to-blue-500/10 border border-purple-500/30 rounded-xl p-6">
              ...
              <p className="text-4xl font-bold text-purple-400">
                {simulationResult.final_effect > 0 ? '+' : ''}{simulationResult.final_effect.toFixed(3)}m
              </p>
            ...
            <div className="bg-gradient-to-br from-green-500/10 to-emerald-500/10 border border-green-500/30 rounded-xl p-6">
              ...
              <p className="text-4xl font-bold text-green-400">
                {simulationResult.cumulative_effect > 0 ? '+' : ''}{simulationResult.cumulative_effect.toFixed(3)}m
              </p>
